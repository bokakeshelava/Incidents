...
SECRET_KEY = 'django-insecure-iim7-_2ik!)7evx^*njyn^bvprwuxo^l%dv9+mi)q4a_f%y5ns'
...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("POSTGRES_NAME", "incident-db"),
        "USER": os.getenv("POSTGRES_USERNAME", "incident-user"),
